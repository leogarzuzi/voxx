...
function gerarNomeArquivoCsv() {
  ...
  return `transferencias-${ano}-${mes}-${dia}-${hora}${minuto}.csv`;
}
...
export default function ControleTransferenciasTabela() {
  ...
  return (
    <section className="voxx-transferencia-module voxx-surface mt-6 min-w-0 overflow-hidden rounded-[26px] p-5">
      ...
      {confirmacaoStatus && (
        <div
          className="voxx-transferencia-modal fixed inset-0 z-[95] flex items-center justify-center bg-[var(--voxx-overlay)] px-4 backdrop-blur-sm"
      ...
      {modalAberto && (
        <div
          className="voxx-transferencia-modal fixed inset-0 z-[90] flex items-center justify-center bg-[var(--voxx-overlay)] px-4 backdrop-blur-sm"
