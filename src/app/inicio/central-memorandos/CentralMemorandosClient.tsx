  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Area para solicitacoes eletronicas entre coordenacao e RH.
        </p>
      </section>
      ...
      <section className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
        ...
        >
            ...
            <span
              className={
                temaDia
                  ...
                  : "rounded-full border border-white/10 bg-white/[0.05] px-3 py-1 text-xs font-bold text-slate-300"
              }
            >
              Novo
            </span>
          ...
          >
            Solicitacao de troca de plantao entre dois colaboradores.
          </p>
