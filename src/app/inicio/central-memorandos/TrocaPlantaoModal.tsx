...
export function TrocaPlantaoModal({
  ...
  const sectionClass = "voxx-surface h-full rounded-[24px] p-5";
        ...
        <form className="space-y-5">
          <div className="grid items-start gap-5 lg:grid-cols-2">
            <section className={sectionClass}>
              <h3 className={`text-base font-semibold ${titleText}`}>Plantão do solicitante</h3>
              ...
              <div className="mt-4 space-y-4">
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    />
                    {!modoEdicao && (
                      <button type="button" onClick={buscarSolicitante} disabled={buscandoSolicitante || enviando} className="voxx-button-primary rounded-xl px-3 py-2 text-sm font-semibold disabled:opacity-50">
            ...
            <section className={sectionClass}>
              <h3 className={`text-base font-semibold ${titleText}`}>Plantão do solicitado</h3>
              ...
              <div className="mt-4 space-y-4">
                <div>
                  ...
                  <div className="mt-1 flex items-center gap-2">
                    ...
                    />
                    {!modoEdicao && (
                      <button type="button" onClick={buscarSolicitado} disabled={buscandoSolicitado || enviando} className="voxx-button-primary rounded-xl px-3 py-2 text-sm font-semibold disabled:opacity-50">
          ...
          <div className="flex justify-end gap-3">
            ...
            <button type="button" onClick={enviarSolicitacao} disabled={!formularioValido} className="voxx-button-primary rounded-xl px-4 py-2 text-sm font-semibold disabled:cursor-not-allowed disabled:opacity-50">
