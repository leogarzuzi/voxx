          ...
          <div className="flex flex-wrap items-start justify-between gap-4">
            ...
            <form onSubmit={pesquisar} className="flex w-full flex-col items-end gap-2 lg:w-auto">
              <div className="flex w-full flex-wrap justify-end gap-2">
                ...
                <button
                  type="submit"
                  className={temaDia ? "h-10 rounded-xl bg-slate-950 px-4 text-sm font-semibold text-white transition hover:bg-slate-800" : "h-10 rounded-xl bg-white px-4 text-sm font-semibold text-slate-950 transition hover:bg-slate-200"}
                >
                  Buscar
                </button>
                <button
                  type="button"
                  onClick={() => setBusca("")}
                  className={temaDia ? "h-10 rounded-xl border border-slate-200 bg-slate-50 px-4 text-sm font-semibold text-slate-700 transition hover:bg-slate-100" : "h-10 rounded-xl border border-white/10 bg-white/[0.04] px-3 text-sm font-semibold text-slate-200 transition hover:bg-white/[0.08]"}
                >
                  Limpar
                </button>
              </div>
