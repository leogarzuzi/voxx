...
function gerarNomeArquivoExcel() {
  ...
  return `base-dados-${ano}-${mes}-${dia}-${hora}${minuto}.csv`;
}
          ...
          >
            ...
            <div className="mt-6 flex justify-end gap-3">
              <button
                type="button"
                onClick={() => setModalFiltroAberto(false)}
                className="voxx-button-secondary rounded-xl px-5 py-2 text-sm font-semibold"
              >
                Cancelar
              </button>
              ...
              <button
                ...
                className="voxx-button-primary rounded-xl px-5 py-2 text-sm font-semibold"
              >
                Aplicar filtro
              </button>
            </div>
