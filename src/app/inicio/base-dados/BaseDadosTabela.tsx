...
export default function BaseDadosTabela() {
  ...
  async function buscarColaboradores(valorBusca?: string) {
    setLoading(true);
    setErro("");
  ...
  // carrega os primeiros registros ao abrir a página
  useEffect(() => {
    buscarColaboradores("");
  }, []);
      ...
      <div className="mb-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <form onSubmit={handleBuscar} className="flex w-full gap-3 lg:w-auto">
          ...
          <button
            type="button"
            onClick={limparBusca}
            className="h-10 rounded-xl border px-5 text-sm font-semibold text-gray-600 transition hover:bg-gray-50"
          >
            Limpar
          </button>
        </form>
